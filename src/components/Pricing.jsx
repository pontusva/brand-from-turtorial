    ...
    <div name='pricing' className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            ...
            <div className='text-center py-8 text-slate-300'>
                ...
                <p className='3xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugit eligendi earum adipisci autem doloremque modi magni voluptas nam nihil debitis?</p>
            </div>

            <div className='grid md:grid-cols-2'>

                <div className='bg-white text-slate-900 m-4 p-8 rounded shadow-2xl relative'>
